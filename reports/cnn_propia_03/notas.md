...
Recall sigue calculandose como 1.0, y accuracy es literalmente el porcentage de dataset (clase: yes) que existe.
...
- También, quité dense porque pienso que dispará mucho los parámetros que tengo, aunque había pensando en tener una red de 500k parámetros inicialmente.
